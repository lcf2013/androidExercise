 ...
 *上下滚动时，自动显示第一个完整item的listview
 */
public class ShowCompleteItemListView extends ListView implements AbsListView.OnScrollListener {
    ...
    public ShowCompleteItemListView(Context context, AttributeSet attrs)
    {
     ...
     * @param defStyle
     */
    public ShowCompleteItemListView(Context context, AttributeSet attrs, int defStyle)
    {
